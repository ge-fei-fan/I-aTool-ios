...
private final class PinyinCandidateProvider {
    ...
    private static let looseKeyAliases: [String: [LooseKeyAlias]] = [
        "sj": [LooseKeyAlias(pinyinKeys: ["shouji"], preferredText: "鎵嬫満")],
        "qwer": [LooseKeyAlias(pinyinKeys: ["chuqu", "waner"], preferredText: "鍑哄幓鐜╁効")],
        "ty": [LooseKeyAlias(pinyinKeys: ["tianyu"], preferredText: "澶╁畤")],
        "ii": [LooseKeyAlias(pinyinKeys: ["o"], preferredText: "鍝?)]
    ]
